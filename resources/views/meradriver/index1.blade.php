                        ...
                        <div class="industry-group">
                           <div
                              ...
                              <div class="premium-collection swiper-wrapper"
                                 ...
                                 <div class="swiper-slide tupple" style="width: 233.123px; margin-right: 16px;">
                                    <span class="industry-card "
                                       link="https://www.meradriver.com/startup-companies-in-india-cat103?title=Startups+actively+hiring&amp;src=discovery_orgExploreCompanies_homepage_srch"
                                       index="7" name="Startups">
                                       <div class="chip-heading-div"><a class="industry-name"
                                             href="https://www.meradriver.com/startup-companies-in-india-cat103?title=Startups+actively+hiring&amp;src=discovery_orgExploreCompanies_homepage_srch">Startups</a>
                                          <img class="ntc__chip-arrow" src="{{asset('meradriver')}}/img/pages/arrow.2b55815e.svg"
                                             alt="arrow-icon">
                                       </div>
                              ...
                              <div class="premium-collection swiper-wrapper"
                                 ...
                                 <div class="swiper-slide swiper-slide-active"
                                    ...
                                    <div class="tuple premium "
                                       data-href="https://www.meradriver.com/amazon-overview-398058?src=premiumLogo"
                                       ...
                                       <div class="contentwrap" style="background-color: rgba(244, 157, 44, 0.03);">
                                          ...
                                          <div class="additionalDetails">
                                             <!-- <span class="star">
                                                <img src="{{asset('meradriver/img/pages/service_2.png')}}" alt="rating" class="starImage">
                                             </span> -->
                                 ...
                                 <div class="swiper-slide swiper-slide-next"
                                    style="width: 233.333px; margin-right: 20px;">
                                    <div class="tuple premium "
                                       data-href="https://www.meradriver.com/cognizant-overview-4156?src=premiumLogo"
                                       ...
                                       <div class="contentwrap" style="background-color: rgba(11, 46, 134, 0.03);">
                                          ...
                                          <div class="additionalDetails">
                                             <!-- <span class="star">
                                                <img src="{{asset('meradriver')}}/img/pages/service_3.png" alt="rating" class="starImage">
                                             </span>
                                              -->
                                          </div>
                                       </div>
                                 ...
                                 <div class="swiper-slide" style="width: 233.333px; margin-right: 20px;">
                                    <div class="tuple premium "
                                       data-href="https://www.meradriver.com/hitachi-energy-overview-5935206?src=premiumLogo"
                                       ...
                                       <div class="contentwrap" style="background-color: rgba(255, 0, 42, 0.03);">
                                          <h3 class="main-6 title" style="-webkit-line-clamp: 2;"><a class="compName "
                                                href="https://www.meradriver.com/hitachi-energy-overview-5935206?src=premiumLogo">Contractual
                                                drivers
                                             </a>
                                          </h3>
                                          <div class="additionalDetails">
                                             <!-- <span class="star">
                                                <img src="{{asset('meradriver')}}/img/pages/service_4.png" alt="rating" class="starImage">
                                             </span> -->
                                 ...
                                 <div class="swiper-slide" style="width: 233.333px; margin-right: 20px;">
                                    <div class="tuple premium "
                                       data-href="https://www.meradriver.com/expleo-overview-4666991?src=premiumLogo"
                                       ...
                                       <div class="contentwrap" style="background-color: rgba(105, 70, 196, 0.03);">
                                          <h3 class="main-6 title" style="-webkit-line-clamp: 2;"><a class="compName "
                                                href="https://www.meradriver.com/expleo-overview-4666991?src=premiumLogo">Outstation
                                                drivers</a>
                                          </h3>
                                          <div class="additionalDetails">
                                             <!-- <span class="star">
                              ...
                              <div class="standard-collection swiper-wrapper"
                                 ...
                                 <div class="swiper-slide swiper-slide-active"
                                    ...
                                    <div class="tuple standard"
                                       data-href="https://www.meradriver.com/meradriver-overview-9999999?src=standardLogo"
                                       ...
                                       <div class="contentwrap">
                                          <h3 class="main-4 title" style="-webkit-line-clamp: 1;">
                                             <a class="compName ellipsis right-arrow"
                                                href="https://www.meradriver.com/meradriver-overview-9999999?src=standardLogo">MeraDriver</a>
                                          </h3>
                                          <div class="additionalDetails">
                                             <span class="star">
                                    ...
                                    <div class="tuple standard row-2"
                                       data-href="https://www.meradriver.com/meradriver-fleet-overview-9999998?src=standardLogo"
                                       ...
                                       <div class="contentwrap">
                                          <h3 class="main-4 title" style="-webkit-line-clamp: 1;">
                                             <a class="compName ellipsis right-arrow"
                                                href="https://www.meradriver.com/meradriver-fleet-overview-9999998?src=standardLogo">MeraDriver
                                                Fleet Services</a>
                                          </h3>
                                          <div class="additionalDetails">
                                             <span class="star">
