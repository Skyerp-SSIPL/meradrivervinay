                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="meta_description" id="" cols="20" rows="5" placeholder="link" disabled class="form-control">{{"http://localhost:8888/overseaseducationlane/landing-page?country="}}</textarea>
                                        </div>
