...
<head>
    <title>Study Abroad Consultant - Overseas Education Lane</title>
    <meta charset="UTF-8">
    ...
    <link id="favicon" rel="shortcut icon" type="image/png" href="{{asset('assets/meradriver/mera.png')}}" />
    ...
    })(window,document,'script','dataLayer','GTM-KLHRGHLP');</script>
    ...
    <script type="application/ld+json">
        {
            ...
            "logo": "{{asset('assets/meradriver/mera.png')}}",
            "sameAs": [
                "https://www.facebook.com/overseasedu.lane/",
                "https://in.linkedin.com/in/overseaseducationlane?trk=public_profile_samename-profile",
                "https://twitter.com/LaneEducation",
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KLHRGHLP"
            ...
            <div class="container ">
                <nav>
                    <div class="oel-logo pt-2" >
                        <a href="{{url('/')}}"><img src="{{ asset('assets/meradriver/mera.png') }}"></a>
                    </div>
                    <ul class="nav_links d-flex" id="nav_links">
                        <li><a href="{{ route('index') }}">Home</a></li>
                        <li><a href="{{ route('about-oel') }}">About Us</a></li>
                        <li><a href="{{ route('programs') }}">Jobs</a></li>
                        <li><a href="{{ route('program-offered') }}">Service</a></li>
                        <li><a href="{{ route('check-eligible') }}"> Drivers</a></li>

                        <li><a href="{{ route('check-eligible') }}"> Packages</a></li>
                        <li><a href="{{ route('contact_us') }}">Contact Us</a></li>
                       
                        <li><a href="{{ route('user-login') }}"><button class="rounded apply-btn fn  border-0 p-2">Login</button></a>
                        </li>
    ...
    data-bot-id="b6e6c68a-2e58-4a00-9b95-caa9d5ab6f7a"
    data-api_key="skybot"
                                    ...
                                    <div class="col-md-8">
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <input type="tel" name="mobile_number" class="form-control" aria-describedby="emailHelp"
                                                pattern="[0-9]{10}" placeholder="Mobile number" id="mobile_number" required>
                                        </div>
