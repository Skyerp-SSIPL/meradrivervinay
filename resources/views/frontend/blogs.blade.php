            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mt-4">
                    <div class="card blogs_card blog_card shadow-sm">
                        <a class="blog-btn text-decoration-none text-dark" href="{{url('blog-details', $item->title)}}">
                        ...
                        <div class="card-body blog_content">
                            ...
                            <div class="blog-button">
                                <a class="blog-btn text-decoration-none text-dark" href="{{url('blog-details', $item->title)}}">Continue Reading <i class="fa-solid fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
