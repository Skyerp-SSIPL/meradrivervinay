                ...
                <div class="col-md-8">
                    <ol class="breadcrumb text-muted mb-0">
                        ...
                        <li class="breadcrumb-item text-muted">
                            Manage Expected Salary
                        </li>
                    </ol>
                </div>
                @can('master_service.create')
                    <div class="col-md-4">
                        <a href="{{ route('create-expectd-salary') }}" class="btn add-btn float-end">
                            <i class="las la-plus"></i>Create New Expected Salary</a>
                    </div>
                @endcan
            </div>
        </div>
            ...
            <table class="table table-striped custom-table mb-0">
                ...
                <tbody id="tableBody">
                    ...
                    <tr>
                        ...
                        <td><a  href="{{route('edit-expectd-salary',$item->id)}}" class="btn btn-info"><i class="fa-solid fa-pen"></i></a></td>
                        @endcan
                        @can('master_service.delete')
                        <td><a href="{{route('delete-expectd-salary',$item->id)}}" class="btn btn-warning"><i class="fa-solid fa-trash"></i></a></td>
                        @endcan
                    </tr>
                    @endforeach
                </tbody>
