                    ...
                    <div class="wizard">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <form>
                                <div class="col-12">
                                    <label>
                                        <b>Have you ever been refused a commercial driving license or driving permit in India or any other country?</b>
                                    </label>
                                        <div class="col-12">
                                            <label>
                                    ...
                                    <div class="col-12 mt-2">
                                        ...
                                        <label><b>Do you currently hold a valid Driving License and, if applicable, a valid Work Visa or Permit to work as a driver?</b></label>
                                        <label><br>
    ...
    <script>
        $(document).ready(function() {
            ...
            function school_data(){
                ...
                const staticOptions  = [
                                    { value: "aadhaar_card", name: "Aadhaar Card" },
                                    { value: "pan_card", name: "PAN Card" },
                                    { value: "passport_photo", name: "Passport-size Photograph" },
                                    { value: "address_proof", name: "Address Proof" },
                                    { value: "driving_license", name: "Driving License" },
                                    { value: "commercial_driving_license", name: "Commercial Driving License" },
                                    { value: "driver_badge", name: "Driver Badge" },
                                    { value: "vehicle_rc", name: "Vehicle Registration Certificate (RC)" },
                                    { value: "vehicle_insurance", name: "Vehicle Insurance Certificate" },
                                    { value: "puc_certificate", name: "PUC Certificate" },
                                    { value: "fitness_certificate", name: "Vehicle Fitness Certificate" },
                                    { value: "vehicle_permit", name: "Vehicle Permit" },
                                    { value: "road_tax_receipt", name: "Road Tax Receipt" },
                                    { value: "bank_passbook", name: "Bank Passbook / Cancelled Cheque" },
                                    { value: "upi_details", name: "UPI / Bank Details for Payments" },
                                    { value: "police_verification", name: "Police Verification Certificate (PCC)" },
                                    { value: "noc_police", name: "Police Station NOC" },
                                    { value: "no_criminal_affidavit", name: "Affidavit of No Criminal Record" }
                                ];
