                            ...
                            <div class="tab-pane fade show active" role="tabpanel" id="step1"
                                ...
                                <form class="row " action="{{ route('store-blogs') }}" method="POST"
                                    ...
                                    <div class="col-md-6 input-group-adss">
                                        ...
                                        <input type="text" name="meta_tags" class="form-control " maxlength="200" required placeholder="Enter Title " />
                                        @error('meta_tags')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 input-group-adss">
                                        ...
                                        <textarea name="meta_description"  class="form-control" placeholder="Enter Meta Description"  cols="20" rows="5"></textarea>
