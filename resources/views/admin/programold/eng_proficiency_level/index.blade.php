    ...
    <div class="card-group mb-3">
      <div class="card">
        <div class="card-body myform">
          <form id="eudcation" action="{{route('eng-proficiency-level')}}" method="get" class="d-flex justify-content-start align-items-center">
            ...
            <div class="col-md-2 px-3">
                <a href="{{route('eng-proficiency-level')}}" class="btn btn-info w-100">Reset</a>
            </div>
