      ...
      <div class="card">
        <div class="card-body myform">
          <form id="eudcation" action="{{route('field-of-study')}}" method="get" class="d-flex justify-content-between">
            ...
            <div class="col-md-2 px-3 align-items-center d-flex ">
              <button type="submit" class="btn btn-info w-100 float-end" id="submit" value="1">Search</button>
            </div>
            <div class="col-md-2 float-start px-3 align-items-center d-flex ">
                <a href="{{route('field-of-study')}}" class="btn btn-info w-100">
                    Reset
                </a>
            </div>
          </form>
