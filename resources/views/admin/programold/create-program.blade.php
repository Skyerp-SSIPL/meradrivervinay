...
<!--                              <option value="NonResidential"  {{ old('programCampus') == 'NonResidential' ? 'selected' : '' }}>NonResidential</option> -->
                    ...
                    <div class="col-md-4" id="grading-number-div" style="display: none;">
                        <div class="form-floating">
                    ...
                    <div class="col-md-4">
                     ...
                     <div class="col-md-4" id="other-exam-input" style="display: none;">
                        <div class="form-floating">
                    ...
                    <div class="col-12 d-flex justify-content-center"><button type="submit" class="btn btn-info  w-25">Submit</button></div>
                 </form>
                <br>
              </div>
            </div>
