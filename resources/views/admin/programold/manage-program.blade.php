...
@section('main-content')
            ...
            <div class="card-body myform">
              <form id="program_filter" action="{{route('program-filter')}}" method="get">
                ...
                <div class="col-md-3 d-flex justify-content-start">
                    <div class="col ps-2">
                  <button type="submit" class="btn mr-3 btn-info d-lg-block float-end  formmrgin w-100" id="submit" value="1">Search</button>
                    </div>
                    <div class="col ps-2">
                   <a href="{{route('manage-program')}}" class="btn mr-3 btn-info d-lg-block float-end  formmrgin w-100">
                       Reset
                   </a>
                    </div>
                </div>
    ...
    <div class="row">
            ...
            <div class="table-responsive">
                <table class="table table-striped custom-table mb-0">
                    ...
                    <tbody id="tableBody">
                        ...
                        <div class="offcanvas offcanvas-end border-0 paymentss-container" tabindex="-1" id="testscrores">
     ...
     {{-- gmat score  --}}
     <div class="offcanvas offcanvas-end border-0 paymentss-container show" tabindex="-1" id="gmat">
        <div class="sidebar-headerset paymentss-header">
            <div class="sidebar-headersets">
        ...
        <div class="offcanvas-body">
            ...
            <div class="row">
                <div class="card-stretch-full">
                    <div class="row ">
                        <form class="row payment-form-payy" id="">
                            <div class="col-12">
                        ...
                        <div class="col-md-12 ps-3 mb-3"><button type="button"
                            class="btn btn-info score">Submit</button></div>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        if ($.isEmptyObject(response)) {
                            ...
                            $.each(score, function(key, value) {
                                $('.score-table').append('<tr><td>' +
                                    ...
                                    value.remarks + '</td><td><a href="#" class="btn btn-warning btn-danger delete-score" data-id="'+value.id+'"><i class="la la-trash"></i></a></td></tr>');
                            });
                        }
                    }
                }).then(function(){
