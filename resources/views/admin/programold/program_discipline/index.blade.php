    ...
    <div class="card-group mb-3">
      <div class="card">
        <div class="card-body myform">
          <form id="eudcation" action="{{route('program-discipline')}}" method="get" class="d-flex justify-content-start align-items-center">
            ...
            <div class="col-md-2 ps-3">
                <a href="{{route('program-discipline')}}" class="btn btn-info w-100">Reset</a>
            </div>
