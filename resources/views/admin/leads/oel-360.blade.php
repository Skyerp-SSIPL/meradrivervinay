...
<script>
  ...
  //     },
  //     success: function(response) {
  //       $('#usr-sub_service').html('');
  //       if (response.subservice.length > 0) {
  //         $.each(response.subservice, function(key, value) {
  //           $('#usr-sub_service').append('<option value="' + value.id + '">' + value.name + '</option>');
  //         });
  //       } else {
  //         $('#usr-sub_service').html('<option value="">No records found</option>');
  //         $('#usr-amount').val('');
  //       }
  //       if (master_service_id == "2") {
  //         var application_fee = $('#application_fee').val();
  //         $('#usr-amount').val(application_fee);
  //         return false;
  //       } else {
  ...
  function getSubService(master_service_id) {
              ...
              $(document).ready(function() {
                $('#sub-service-input').on('click', function() {
                  $(this).closest('.custom-dropdown').find('.dropdown-menu').toggleClass('show');
                });
