                ...
                <form action="{{ route('student-review') }}" method="GET">
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col ps-2">
                                <button type="submit" value="submit" class="btn btn-info d-lg-block  formmrgin w-100"
                                    name="submit">Filter </button>
                            </div>
                            <div class="col ps-2">
                                <a href="{{ route('student-review') }}" class="btn btn-info d-lg-block w-100 formmrgin">Reset
                                </a>
                            </div>
                        </div>
                        </div>
