    ...
    <div class="container py-4">
        <div class="email-container">
            ...
            <div class="email-content">
                <h6 class="signature-name">Your Profile is Successfully Created</h6>
                ...
                <p>Your profile has been successfully created. Use the credentials below to track updates on your
                    admission process:
                </p>
                <li>URL: <a href="https://www.overseaseducationlane.com/user-login">overseaseducationlane.com</a></li>
                <li>Username: {{ $student_data['email'] }},</li>
                <li>Password:</li>
                <br>
            ...
            <div class="email-footer">
                <p>
                    ...
                    Address: A 12-13,2nd Floor, Sector 16 Noida, Uttar Pradesh, 201301<br>
