...
class DashboardController extends Controller
{
    ...
    public function storecountry_campaign(Request $request)
    {
        ...
        $data =CountryCampaign::insert([
            ...
            'meta_description'=>"http://localhost:8888/overseaseducationlane/landing-page?country=",
          
        ]);
        return redirect()->route('country_campaign')->with('success', 'Ads Added successfully.');
    }
