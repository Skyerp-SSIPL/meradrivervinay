...
class StudentController extends Controller
{
    ...
    //       $program_applied = PaymentsLink::with('program:name,id,school_id')->select('id','user_id','email','program_id')->orwhere('payment_type_remarks','applied_program_pay_later')
    //                         ->orwhere('payment_type_remarks','applied_program')->where('email', $email)->get();
    //       if($program_applied){
