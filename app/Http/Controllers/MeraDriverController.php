...
class MeraDriverController extends Controller
{

    public function home()
    {
        
        return view('meradriver.index');
    }
    public function company()
    {
        
        return view('meradriver.about-us');
    }
    public function jobs()
    {
        
        return view('meradriver.category');
    }
    public function blog()
    {
        
        return view('meradriver.blog-home');
    }

    public function contact()
    {
        
        return view('meradriver.contact');
    }
    public function price()
    {
        
        return view('meradriver.price');
    }
