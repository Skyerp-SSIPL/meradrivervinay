...
use App\Models\{Country, Program, SchoolReview, SchoolType, University,PaymentsLink};
...
class UniversityController extends Controller
{
        ...
        if($request->tab1){
            ...
            if($request->university_id){
                $validator = Validator::make($request->all(), [
                     //'university_name' => [
                      //  'required|max:200',
                         //'unique:universities,university_name,' . $request->university_id
                  //  ],
    ...
    public function view_university(Request $request,$id)
    {
        ...
        $program =Program::with('university_name:id,logo,website,university_name,country_id','programSubLevel:program_id,name,id','educationLevelprogram:name,id,program_level_id,program_sublevel_id','educationLevel','currency_data:id,currency')
                  ->where('school_id', $id)
