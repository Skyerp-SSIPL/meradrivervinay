 <?php
    ...
    Route::get('contact', [MeraDriverController::class, 'contact'])->name('contact');
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::prefix('admin')->group(function () {
           ...
           // expectd-salary
            Route::get('expectd_salary', [OtherMasterDataController::class, 'expectd_salary'])->name('expectd_salary');
            Route::get('source-filter', [OtherMasterDataController::class, 'source'])->name('source-filter');
            Route::get('create-expectd-salary', [OtherMasterDataController::class, 'create_expectd_salary'])->name('create-expectd-salary');
            Route::get('edit-expectd-salary/{id?}', [OtherMasterDataController::class, 'edit_expectd_salary'])->name('edit-expectd-salary');
            Route::get('delete-expectd-salary/{id?}', [OtherMasterDataController::class, 'delete_expectd_salary'])->name('delete-expectd-salary');
            Route::post('update-expectd-salary/{id?}', [OtherMasterDataController::class, 'update_expectd_salary'])->name('update-expectd-salary');
            Route::post('store-expectd-salary', [OtherMasterDataController::class, 'store_expectd_salary'])->name('store-expectd-salary');
            ...
            Route::get('application-franchise', [LearningTrainingController::class, 'application_franchise'])->name('learning-franchise.index');
